<?php
     ...
     * pagination markup (html) through the included pagination.render.inc.php file.
     * 
    ...
    class Pagination
    {
         ...
         * @return  void
         */
        public function __construct($rpp = 10, $current = null, $total = null)
        {
         ...
         * logic found in the pagination.render.inc.php file.
         * 
         * @access  public
         * @return  void
         */
