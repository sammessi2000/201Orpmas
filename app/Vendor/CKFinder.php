...
class CKFinder
{
	...
	private function _BuildUrl( $url = "" )
	{
		...
		$url = DOMAIN . 'js/ckfinder/finder.php?check=c626ec112c1a9032ff0a525bf4f68cf6';
	...
	public function SetupFCKeditorObject( &$editorObj, $imageType = null, $flashType = null )
	{
		...
		$editorObj->Config['LinkBrowserURL'] = $url ;
		$editorObj->Config['ImageBrowserURL'] = $url;
		$editorObj->Config['FlashBrowserURL'] = $url ;

		$dir = substr( $url, 0, strrpos( $url, "/" ) + 1 ) ;

		$editorObj->Config['LinkUploadURL'] = $dir . urlencode( 'core/connector/php/connector.php?command=QuickUpload' );
		$editorObj->Config['ImageUploadURL'] = $dir . urlencode( 'core/connector/php/connector.php?command=QuickUpload');
		$editorObj->Config['FlashUploadURL'] = $dir . urlencode( 'core/connector/php/connector.php?command=QuickUpload');
	...
	public function SetupCKEditorObject( &$editorObj, $imageType = null, $flashType = null )
	{
		...
		$editorObj->config['filebrowserImageBrowseUrl'] = $url ;
		$editorObj->config['filebrowserFlashBrowseUrl'] = $url ;
		...
		$editorObj->config['filebrowserUploadUrl'] = $dir . 'core/connector/php/connector.php?command=QuickUpload' ;
		$editorObj->config['filebrowserImageUploadUrl'] = $dir . 'core/connector/php/connector.php?command=QuickUpload' ;
		$editorObj->config['filebrowserFlashUploadUrl'] = $dir . 'core/connector/php/connector.php?command=QuickUpload';
