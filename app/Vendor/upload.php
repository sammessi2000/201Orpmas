...
class upload {
    ...
    var $image_watermark_w;
    var $image_watermark_h;

    var $image_text_font_file;
                ...
                if ($this->processed && $image_src) {
                    ...
                    if ($this->image_watermark!='' && file_exists($this->image_watermark)) {
                        ...
                        if ($watermark_checked) {
                            ...
                            $watermark_src_width  = imagesx($filter);
                            $watermark_src_height = imagesy($filter);

                            $watermark_dst_width = $this->image_src_x / 2;
                            $watermark_dst_height = $watermark_dst_width * $this->image_watermark_h / $this->image_watermark_w;
                            ...
                            if (strpos($this->image_watermark_position, 'c') !== false) {
                                $this->image_watermark_x = ($this->image_src_x - $watermark_src_width) / 2;
                                $this->image_watermark_y = ($this->image_src_y - $watermark_dst_height) / 2;
                            }
