...
if(! defined('DEFAULT_WIDTH') )				define ('DEFAULT_WIDTH', 60);							// Default thumbnail width. Allows overrid in timthumb-config.php
if(! defined('DEFAULT_HEIGHT') )			define ('DEFAULT_HEIGHT', 60);							// Default thumbnail height. Allows overrid in timthumb-config.php
...
class timthumb {
	...
	public function __construct(){
		...
		if(preg_match('/thucuc/', $this->src))
		{
			$this->src = str_replace('/thucuc', '', $this->src);
		}
