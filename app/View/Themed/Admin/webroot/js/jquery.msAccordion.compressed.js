...
(function($) {
    $.fn.msAccordion = function(options) {
        options = $.extend({ currentDiv: '1', previousDiv: '', vertical: false, defaultid: 0, currentcounter: 0, intervalid: 0, autodelay: 0, event: "click", alldivs_array: new Array() }, options);
        ...
        allDivs.each(function (current) {
            ...
            $("#" + sTitleID).bind(options.event, function (e) {
                e.preventDefault();
                pause();
                openMe(sTitleID)
            })
        ...
        function openMe(id) {
            ...
            console.log($("#" + sContentID).css("display"));
