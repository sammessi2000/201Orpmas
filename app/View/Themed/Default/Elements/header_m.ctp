...
<head>
    ...
    <link rel="stylesheet"
        href="<?php echo DOMAIN; ?>theme/<?php echo $theme_directory; ?>/<?php echo $v; ?>?v=<?php echo STYLE_VERSION; ?>">
    <?php endforeach; ?>
    ...
    <link rel="icon" type="image/png" href="<?php echo DOMAIN . $this->App->t('logo'); ?>" />
...
<body class="<?php echo $body; ?>">
    ...
    <a href="<?php echo DOMAIN; ?>default/home/change_active_editor" class="hidden-xs" title="">
        <span class="btn btn-primary"
            style="position: fixed; top: 0; right: 5px; z-index: 999998;"><?php echo $str; ?></span>
    </a>
    <?php endif; ?>
    <!--/nocache-->

    <div class="menu-head-mobile" data-spy="affix" data-offset-top="205">
        <div class="wrap">
                        ...
                        <div class="bars-menu">
                            <a href="javascript:;">
                                <svg width="22" height="18" viewBox="0 0 22 18" fill="none"
                                    ...
                                    <path d="M1 1H21" stroke="#1C659F" stroke-width="2" stroke-miterlimit="10"
                                        stroke-linecap="round" />
                                    <path d="M1 9H13" stroke="#1C659F" stroke-width="2" stroke-miterlimit="10"
                                        stroke-linecap="round" />
                                    <path d="M1 17H21" stroke="#1C659F" stroke-width="2" stroke-miterlimit="10"
                                        stroke-linecap="round" />
                                </svg>
                            </a>
                        </div>
                            ...
                            <div data-toggle="dropdown" id="contry">
                                ...
                                <div class="country en hidden">
                                    <svg width="22" height="15" viewBox="0 0 22 15" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <mask id="mask0_93_184" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0"
                                            y="0" width="22" height="15">
                                ...
                                <div class="country ja hidden">
                                    <svg width="22" height="15" viewBox="0 0 22 15" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <rect x="0.05" y="0.05" width="21.9" height="14.9" fill="white" stroke="#3D3A3A"
                                            stroke-width="0.1" />
                                        <path
