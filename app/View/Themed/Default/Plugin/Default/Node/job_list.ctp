            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-9">
                        ...
                        <div class="tuyendung-content">
                            <div class="tuyendung-title">
                                <span><?php echo $job[0]['Job']['title']; ?></span>
                        ...
                        ?>
                            <?php $required = $job[0]['Job']['thongtin'];
                        if ($required != '' && $this->App->is_valid_json($required)) {
                                $required = json_decode($required);
                        }
                    ...
                    <div class="col-sm-3 scroll-box">
                        <div class="other-recruit-title visible-xs"><?php echo $this->App->t_a('general_text_19'); ?></div>
                        <?php $i = 0; ?>
                        ...
                        <div class="tuyendung-box active">
                            ...
                            <div class="box-tuyendung-info">
                                ...
                                <span class="tuyendung-time">
                                    <?php echo $this->App->getDateDiff($v['Job']['created'],1) . ' trước'; ?>
                                </span>
