...
<div class="navbar margin-none">
    <div class="navbar-inner radius-none">
        ...
        <ul class="nav pull-right">
            <li>
                <a href="<?php echo Router::url(array('plugin' => 'admin', 'controller' => 'admin_' . $type, 'action' => $type . '_add')); ?>">
    ...
    <table class="table table-hover table-bordered">
        ...
        <tr>
            ...
            */ ?>
            ...
            <td>                
                <a href="<?php echo Router::url(array('plugin'=>'admin', 'controller'=>'admin_' . $type, 'action'=>$type . '_edit', $v['Node']['id']), true); ?>"><i class="icon icon-edit"></i></a> &nbsp;
            ...
            <td>
                <a href="<?php echo DOMAINAD; ?>admin_<?php echo $type; ?>/<?php echo $type; ?>_copy/<?php echo $v['Node']['id']; ?>">
