    ...
    <form action="" method="post" class="form-horizontal">
        <div class="row-fluid news_content_workspace">
            ...
            <div class="control-group">
                ...
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.server_category', array('label' => false, 'div' => false, 'required', 'class' => 'span6', 'options' => $category_tree, 'empty' => 'Chọn mục lục')); ?>
                </div>
            </div>
         
            <div class="control-group">
                <div class="span1 text-bold">CPU </div>
                <div class="span9">
            ...
            <div class="control-group">
                <div class="span1 text-bold">HDD </div>
                <div class="span9">
            ...
            <div class="control-group">
                <div class="span1 text-bold">Ram </div>
                <div class="span9">
