...
<div class="navbar margin-none">
    <div class="navbar-inner radius-none">
        <a href="#" class="brand">Sửa <?php echo $form_title; ?></a>
    </div>
    ...
    <form action="" method="post" class="form-horizontal">
        <div class="row-fluid news_content_workspace">
            ...
            <div class="control-group">
                ...
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.server_category', array('label' => false, 'div' => false, 'required', 'class' => 'span6', 'options' => $category_tree, 'selected' => $this->data[$tbl]['server_category'], 'empty' => 'Chọn mục lục')); ?>
                </div>
            </div>
         
            <div class="control-group">
                <div class="span1 text-bold">CPU (cpu)</div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.cpu', array('label' => false, 'div' => false, 'class' => 'span6 typeahead-cpu')); ?>
                </div>
            </div>

            <div class="control-group">
                <div class="span1 text-bold">HDD (hdd)</div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.hdd', array('label' => false, 'div' => false, 'class' => 'span6 typeahead-hdd')); ?>
                </div>
            </div>

            <div class="control-group">
                <div class="span1 text-bold">Ram (ram)</div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.ram', array('type'=>'text', 'label' => false, 'div' => false, 'class' => 'span6 typeahead-ram')); ?>
                </div>
            </div>


            <div class="control-group">
                <div class="span1 text-bold">IP (ip)</div>
                <div class="span9">
            ...
            <div class="control-group">
                <div class="span1 text-bold">WB Trong nước (trongnc) </div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.trongnc', array('label' => false, 'div' => false, 'class' => 'span6')); ?>
                </div>
            </div>

            <div class="control-group">
                <div class="span1 text-bold">WB Quốc tế (qte) </div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.qte', array('label' => false, 'div' => false, 'class' => 'span6')); ?>
                </div>
            </div>

            <div class="control-group">
                <div class="span1 text-bold">Dữ liệu truyền (bandwidth) </div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.bandwidth', array('label' => false, 'div' => false, 'class' => 'span6')); ?>
                </div>
            </div>

            <div class="control-group">
                <div class="span1 text-bold">Giá 1 tháng </div>
                <div class="span9">
            ...
            <div class="control-group">
                <div class="span1 text-bold">Giá 3 tháng</div>
                <div class="span9">
            ...
            <div class="control-group">
                <div class="span1 text-bold">Giá 6 tháng </div>
                <div class="span9">
            ...
            <div class="control-group">
                <div class="span1 text-bold">Giá 12 tháng </div>
                <div class="span9">
            ...
            <div class="control-group">
                <div class="span1 text-bold">Giá 24 tháng </div>
                <div class="span9">
            ...
            <div class="control-group">
                <div class="span1 text-bold">Giá ẩn </div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.price_hide', array('type'=>'text', 'label' => false, 'div' => false, 'class' => 'span6')); ?>
                </div>
            </div>
...
$ram_list = explode("\n", $settings['ram_list']);
$ram_lists = array();
foreach($ram_list as $c)
    $ram_lists[] = trim($c);

$hdd_list = explode("\n", $settings['hdd_list']);
$hdd_lists = array();
foreach($hdd_list as $c)
    $hdd_lists[] = trim($c);
?>
