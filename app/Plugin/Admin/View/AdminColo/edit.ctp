    ...
    <form action="" method="post" class="form-horizontal">
        <div class="row-fluid news_content_workspace">
            ...
            <div class="control-group">
                ...
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.colo_category', array('label' => false, 'div' => false, 'required', 'class' => 'span6', 'options' => $category_tree, 'selected' => $this->data[$tbl]['colo_category'], 'empty' => 'Chọn mục lục')); ?>
                </div>
            </div>
  
            <div class="control-group">
                <div class="span1 text-bold">Không gian </div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.khonggian', array('label' => false, 'div' => false, 'class' => 'span6')); ?>
                </div>
            </div>

            <div class="control-group">
                <div class="span1 text-bold">Ổ cắm mạng </div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.ocam', array('label' => false, 'div' => false, 'class' => 'span6')); ?>
                </div>
            </div>

            <div class="control-group">
                <div class="span1 text-bold">Dữ liệu truyền </div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.bandwidth', array('type'=>'text', 'label' => false, 'div' => false, 'class' => 'span6')); ?>
                </div>
            </div>


            <div class="control-group">
                <div class="span1 text-bold">WB Trong nước </div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.bwtrongnc', array('label' => false, 'div' => false, 'class' => 'span6')); ?>
                </div>
            </div>

            <div class="control-group">
                <div class="span1 text-bold">WB Quốc tế </div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.bwqte', array('label' => false, 'div' => false, 'class' => 'span6')); ?>
                </div>
            </div>

            <div class="control-group">
                <div class="span1 text-bold">Công suất nguồn</div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.csnguon', array('label' => false, 'div' => false, 'class' => 'span6')); ?>
                </div>
            </div>
            ...
            <div class="control-group">
                <div class="span1 text-bold">Uptime </div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.uptime', array('label' => false, 'div' => false, 'class' => 'span6')); ?>
                </div>
            </div>
