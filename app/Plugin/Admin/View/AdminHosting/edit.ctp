    ...
    <form action="" method="post" class="form-horizontal">
        <div class="row-fluid news_content_workspace">
            ...
            <div class="control-group">
                ...
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.hosting_category', array('label' => false, 'div' => false, 'required', 'class' => 'span6', 'options' => $category_tree, 'selected' => $this->data[$tbl]['hosting_category'], 'empty' => 'Chọn mục lục')); ?>
                </div>
            </div>
