...
<div class="navbar margin-none">
    <div class="navbar-inner radius-none">
        ...
        <a href="<?php echo DOMAINAD . 'admin_' . $type . '/setting'; ?>">
            <span class="icon icon-cog pull-left" style="margin-top: 12px;"></span> 
            <span class="pull-left" style="margin-top: 10px; padding-left: 5px;">Form so sánh</span>
        </a>
    ...
    */ ?>
    <table class="table table-hover table-bordered">
        ...
        <tr>
            ...
            <td>
                <?php if(isset($category_tree[$v[$tbl]['hosting_category']])) echo $category_tree[$v[$tbl]['hosting_category']]; ?>
           ...
           <!--  <td>
            ...
            <td>
                <a href="<?php echo DOMAINAD; ?>admin_<?php echo $type; ?>/update_field/featured/<?php echo $v[$tbl]['id']; ?>">
