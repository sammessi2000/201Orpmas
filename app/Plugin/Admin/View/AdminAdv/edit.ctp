    ...
    <form action="" method="post" class="form-horizontal">
        <div class="row-fluid news_content_workspace">
            ...
            <div class="control-group">
                ...
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.adv_category', array('label' => false, 'div' => false, 'required', 'class' => 'span6', 'options' => $category_tree, 'selected' => $this->data[$tbl]['adv_category'], 'empty' => 'Chọn mục lục')); ?>
                </div>
            </div>

            <div class="control-group">
                <div class="span1 text-bold">Số từ khóa </div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.num', array('label' => false, 'div' => false, 'class' => 'span6')); ?>
                </div>
            </div>

            <div class="control-group">
                <div class="span1 text-bold">Số mẫu quảng cáo </div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.template', array('type'=>'text', 'label' => false, 'div' => false, 'class' => 'span6')); ?>
                </div>
            </div>

            <div class="control-group">
                <div class="span1 text-bold">Giá thành </div>
                <div class="span9">
