...
<?php echo $this->Admin->admin_head('Sửa Size'); ?>
<?php echo $this->Admin->admin_breadcrumb('Sửa Size'); ?>
...
<div class="box-content">
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->hidden('Size.title'); ?>
            <?php echo $this->Form->input('Size.' . $title, array('type'=>'text','label'=>false,'div'=>false, 'class'=>'span6')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <?php echo $this->Form->input('Size.image', array('label' => false, 'div' => false, 'class' => 'span6 image_preview', 'id' => 'thumbnail', 'required')); ?>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->input('Size.website', array('label' => false, 'div' => false, 'class' => 'span6')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                $initialValue = $this->data['Size'][$description];

                echo $CKEditor->editor("data[Size][" . $description . "]", $initialValue, "extra");
                ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                $initialValue = $this->data['Size'][$content];

                echo $CKEditor->editor("data[Size][" . $content . "]", $initialValue, "extra");
                ?>
            </div>
        </div>
*/ ?>
