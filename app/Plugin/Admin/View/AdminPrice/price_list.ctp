...
<?php echo $this->Admin->admin_head('Danh sách Price'); ?>
<?php echo $this->Admin->admin_breadcrumb('Danh sách Price'); ?>
...
<div class="box box-color box-bordered">
	...
	<table class="table table-bordered table-hover">
		...
		<tr>
			...
			<!-- <td>
				<img src="<?php //echo DOMAIN; ?><?php //echo $v['Price']['image']; ?>" style="height: 70px" />
			</td> -->
			<td><?php echo $v['Price']['title']; ?></td>
			<!-- <td style="text-align: center;">
				<a href="<?php echo DOMAINAD; ?>admin_size/update_field/featured/<?php echo $v['Price']['id'] ?>">
					<?php if($v['Price']['featured'] == 1) : ?>
            ...
            <td>
                <input name="pos[<?php echo $v['Price']['id']; ?>]" value="<?php echo $v['Price']['pos']; ?>" style="width: 30px;" />
            </td>

			<td style="text-align: center;">
				<a href="<?php echo DOMAINAD . "admin_size/size_edit/" . $v['Price']['id']; ?>">
					<i class="icon icon-edit"></i>
				</a> 
			</td>
			
			<td style="text-align: center;">
				<a href="#" class="confirm-delete" goto="<?php echo DOMAINAD . 'admin_size/size_delete/' . $v['Price']['id']; ?>?rp=<?php echo $redirectPage; ?>">
					<i class="icon icon-trash"></i>
				</a>
			</td>

			<td style="text-align: center;"><?php echo $v['Price']['id']; ?></td>
		</tr>
		<?php endforeach; ?>
		<?php endif; ?>
	</table>
