...
<?php echo $this->Admin->admin_head('Sửa Price'); ?>
<?php echo $this->Admin->admin_breadcrumb('Sửa Price'); ?>
...
<div class="box-content">
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $this->Form->hidden('Price.title'); ?>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                $initialValue = $this->data['Price'][$description];
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                $initialValue = $this->data['Price'][$content];

                echo $CKEditor->editor("data[Price][" . $content . "]", $initialValue, "extra");
                ?>
            </div>
        </div>
*/ ?>
