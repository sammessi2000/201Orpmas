...
<form action="<?php echo DOMAINAD; ?>admin_product/product_add" method="post" class="form-horizontal form-main">
...
<form action="<?php echo DOMAINAD; ?>admin_product/product_add" method="post" class="form-horizontal form-main">
    ...
    <div id="main">
        <div class="container-fluid">
            <?php echo $this->Admin->admin_head('Sửa Dự án'); ?>
            <?php echo $this->Admin->admin_breadcrumb('Sửa Dự án'); ?>
            ...
            <div class="box">
                <div class="box-content">
                    <div class="tabs tab-list">
                        <ul>
                            <li>
                                <a href="#tab1" class="active"><i class="icon-inbox"></i> Thông tin Dự án</a>
                            </li>
                            <!--       <li class="">
                <a href="#tab2"><i class="icon-lock"></i> Nâng cao</a>
            </li> -->
                ...
                <div class="controls">
                    <?php echo $this->Form->input('Product.code',array('type'=>'text','label'=>false,'div'=>false,'class'=>'span3')); ?>
                </div>
            </div>  -->
            ...
            <?php foreach($att_data as $v) { ?>
                ...
                <div class="controls">
                    Tên: 
                    <input type="text" name="data[Thuoctinh][<?php echo $att1; ?>][<?php echo $tt; ?>][ten]" class="span3" value="<?php echo $v->ten; ?>" />
                    Giá trị: 
                    <textarea name="data[Thuoctinh][<?php echo $att1; ?>][<?php echo $tt; ?>][giatri]"><?php echo $v->giatri; ?></textarea> 
                    <?php /*
                    Giá niêm yết: 
                    <input type="text" name="data[Thuoctinh][<?php echo $att1; ?>][<?php echo $tt; ?>][niemyet]" class="span2" value="<?php echo isset($v->niemyet) ? $v->niemyet : ''; ?>" />
                    
                    &nbsp; <span class="delete_this_tt" alt=".img<?php echo $tt; ?>"><em>(Xóa)</em></span>
                </div>
                </div>
            <?php $tt++; } ?>
            <?php } ?>
                    ...
                    <span class="btn btn-warning add-more-thuoctinh">Thêm Thông số kỹ thuật</span>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="thumbnail-preview thumbnail image4"></div>
                                <?php echo $this->Form->input('Product.image4', array('type'=>'text','label'=>false,'div'=>false, 'id'=>'image4', 'class'=>'span6 image_preview')); ?>
                                <input type="button" class="btn btn-success" onclick="file_manager('image4');"
                                    value="Chọn ảnh"> &nbsp;(.jpg, .gif, .png, .swf)
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="thumbnail-preview thumbnail image3"></div>
                                <?php echo $this->Form->input('Product.image3', array('type'=>'text','label'=>false,'div'=>false, 'id'=>'image3', 'class'=>'span6 image_preview')); ?>
                                <input type="button" class="btn btn-success" onclick="file_manager('image3');"
                                    value="Chọn ảnh"> &nbsp;(.jpg, .gif, .png, .swf)
                            </div>
                        </div>
 ...
 -->
                    ...
                    // $initialValue = $this->data['Product'][$description];
                    // echo $CKEditor->editor("data[Product][".$description."]", $initialValue, "extra");
                    echo $this->Form->input('Product.'.$description, array('type' => 'textarea', 'div' => false, 'label' => false, 'class' => 'span11 news_description', 'rows' => 3, 'cols' => false, 'required'));
                    ?>
                        ...
                        <div class="control-group">
                            <label class="control-label">Chi tiết/Mục tiêu khóa học </label>
                            <div class="controls">
                                <?php
                    $CKEditor = new CKEditor();
                    $CKEditor->config['width'] = '740';
