<form action="" method="post" class="form-horizontal form-main">
    <div id="main">
        <div class="container-fluid">
            <?php echo $this->Admin->admin_head('Thêm mới Dịch vụ'); ?>
            <?php echo $this->Admin->admin_breadcrumb('Thêm mới Dịch vụ'); ?>
                ...
                <a href="#tab2"><i class="icon-lock"></i> Nâng cao</a>
                    ...
                    <div id="tab1" class="tab-body">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <?php echo $this->Form->input('category_id', array('type'=>'select','label'=>false,'div'=>false, 'options'=>$category_tree, 'style'=>'height: 200px;', 'multiple' => true, 'required')); ?>
                            </div>
                        </div>
...
*/ ?>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                    <?php echo $this->Form->input('Product.content', array('type' => 'textarea', 'div' => false, 'label' => false, 'class' => 'span10', 'rows' => 6)); ?>
                </div>
                    </div>
                </div>
...
$('.add-more-thuoctinh').click(function() {
    ...
    str += 'Tên: ';
    str += '<input type="text" name="data[Thuoctinh][att1][' + num + '][ten]" class="span3" /> ';
    str += 'Giá trị: ';
    str += '<textarea type="text" name="data[Thuoctinh][att1][' + num + '][giatri]" class="span6"></textarea>';
    // str += '<input type="text" name="data[Thuoctinh][att1][' + num + '][giatri]" class="span6" /> ';
    /*
    str += 'Giá niêm yết: ';
    str += '<input type="text" name="data[Thuoctinh][att1][' + num + '][niemyet]" class="span2" /> ';
    */
