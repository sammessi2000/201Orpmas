...
$address = $lang != 'vi' ? 'address_' . $lang : 'address'; 
?>

<form action="" method="post" class="form-horizontal form-main">
<div id="main">
<div class="container-fluid">
<?php echo $this->Admin->admin_head('Sửa link'); ?>
<?php echo $this->Admin->admin_breadcrumb('Sửa link'); ?>
...
<div class="box-content">
	...
	<!-- <div class="control-group">
		...
		<div class="controls">
            <?php echo $this->Form->hidden('Agency.title'); ?>
