    ...
    <form action="" method="post" class="form-horizontal">
        <div class="row-fluid news_content_workspace">
            <div class="control-group">
                <div class="span1 text-bold">Tên dịch vụ </div>
                <div class="span9">
            ...
            <div class="control-group">
                <div class="span1 text-bold">Ảnh đại diện </div>
                <div class="span9">
            ...
            <div class="control-group">
                <div class="span1 text-bold">Giá </div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.price', array('label' => false, 'div' => false, 'class' => 'span6')); ?>
                </div>
            </div>

            <div class="control-group">
                <div class="span1 text-bold">Link đến </div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.link', array('label' => false, 'div' => false, 'class' => 'span6')); ?>
                </div>
            </div>

            <div class="control-group">
                <div class="span1 text-bold">Mô tả </div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.description', array('type'=>'textarea', 'label' => false, 'div' => false, 'class' => 'span11')); ?>
                </div>
            </div>
