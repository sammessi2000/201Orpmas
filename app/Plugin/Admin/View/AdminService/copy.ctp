...
<div class="navbar margin-none">
    <div class="navbar-inner radius-none">
        <a href="#" class="brand">Sao chép <?php echo $form_title; ?></a>
    </div>
...
<div class="well bg-white radius-none">
    ...
    <form action="<?php echo DOMAINAD; ?>admin_<?php echo $type; ?>/<?php echo $type; ?>_add" method="post" class="form-horizontal">
