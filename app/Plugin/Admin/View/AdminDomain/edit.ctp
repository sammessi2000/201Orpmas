    ...
    <form action="" method="post" class="form-horizontal">
        <div class="row-fluid news_content_workspace">
            <div class="control-group">
                <div class="span1 text-bold">Đuôi mở rộng </div>
                <div class="span9">
            ...
            <div class="control-group">
                ...
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.domain_category', array('label' => false, 'div' => false, 'required', 'class' => 'span6', 'options' => $category_tree, 'selected' => $this->data[$tbl]['domain_category'], 'empty' => 'Chọn mục lục')); ?>
                </div>
            </div>

            <div class="control-group">
                <div class="span1 text-bold">Phí khởi tạo </div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.price_setup', array('type'=>'text', 'label' => false, 'div' => false, 'class' => 'span6 number')); ?>
                </div>
            </div>

            <div class="control-group">
                <div class="span1 text-bold">Phí đăng ký </div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.price_create', array('type'=>'text', 'label' => false, 'div' => false, 'class' => 'span6 number')); ?>
                </div>
            </div>

            <div class="control-group">
                <div class="span1 text-bold">Phí duy trì </div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.price_renew', array('type'=>'text', 'label' => false, 'div' => false, 'class' => 'span6 number')); ?>
                </div>
            </div>

            <div class="control-group">
                <div class="span1 text-bold">Transfer </div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.price_transfer', array('type'=>'text', 'label' => false, 'div' => false, 'class' => 'span6 number')); ?>
                </div>
            </div>
