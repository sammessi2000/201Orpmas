...
<?php echo $this->Admin->admin_head('Sửa mới'); ?>
<?php echo $this->Admin->admin_breadcrumb('Sửa mới'); ?>
...
<div class="box-content">
	...
	<div class="control-group">
		...
		<div class="controls">
			<?php echo $this->Form->input('Support.image', array('type'=>'text', 'label' => false, 'div' => false, 'class' => 'span6', 'id' => 'thumbnail', 'required')); ?>
