<div class="navbar margin-none">
    <div class="navbar-inner radius-none">
        <a class="brand" href="#">Thêm mới agency</a>
    </div>
</div>
...
<?php echo $this->Form->create(null, array('url'=>array('plugin'=>'admin', 'controller'=>'admin_agency','action'=>'agency_add'), 'type'=>'post', 'class'=>'form-horizontal')); ?>
