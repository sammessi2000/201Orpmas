    ...
    <form action="" method="post" class="form-horizontal">
        <div class="row-fluid news_content_workspace">
            ...
            <div class="control-group">
                ...
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.cloud_category', array('label' => false, 'div' => false, 'required', 'class' => 'span6', 'options' => $category_tree, 'selected' => $this->data[$tbl]['cloud_category'], 'empty' => 'Chọn mục lục')); ?>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.ram', array('label' => false, 'div' => false, 'class' => 'span6 typeahead-ram')); ?>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.hdd', array('type'=>'text', 'label' => false, 'div' => false, 'class' => 'span6 typeahead-hdd')); ?>
                </div>
            </div>
