...
<?php echo $this->Admin->admin_head('Thêm hình ảnh'); ?>
<?php echo $this->Admin->admin_breadcrumb('Thêm hình ảnh'); ?>
...
<div class="box-content">	
	...
	<div class="control-group">
		...
		<div class="controls">
			<?php echo $this->Form->input('Banner.link', array('type'=>'text','label'=>false,'div'=>false,'value'=>'#', 'required'=>'required', 'class'=>'span6')); ?>
		</div>
	</div>
