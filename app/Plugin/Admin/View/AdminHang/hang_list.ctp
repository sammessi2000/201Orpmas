...
<?php echo $this->Admin->admin_head('Danh sách Đối tác'); ?>
<?php echo $this->Admin->admin_breadcrumb('Đối tác'); ?>

<div style="margin:10px 0 10px;" class="row-fluid">
    <?php echo $this->Session->flash(); ?>
    <a href="<?php echo DOMAINAD; ?>admin_hang/hang_add" class="btn btn-large btn btn-orange pull-right">Thêm</a>
	...
	<table class="table table-bordered table-hover">
		...
		<tr>
			<td><?php echo $stt; $stt++; ?></td>
                        <td>
                            <img src="<?php echo DOMAIN; ?><?php echo $v['Hang']['image']; ?>" style="height: 70px" />
                        </td>
			<td><?php echo $v['Hang']['title']; ?></td>
			<!-- <td style="text-align: center;">
				<a href="<?php echo DOMAINAD; ?>admin_hang/update_field/featured/<?php echo $v['Hang']['id'] ?>">
					<?php if($v['Hang']['featured'] == 1) : ?>
            ...
            <td>
                <input name="pos[<?php echo $v['Hang']['id']; ?>]" value="<?php echo $v['Hang']['pos']; ?>" style="width: 30px;" />
            </td>

			<td style="text-align: center;">
				<a href="<?php echo DOMAINAD . "admin_hang/hang_edit/" . $v['Hang']['id']; ?>">
					<i class="icon icon-edit"></i>
				</a> 
			</td>
			
			<td style="text-align: center;">
				<a href="#" class="confirm-delete" goto="<?php echo DOMAINAD . 'admin_hang/hang_delete/' . $v['Hang']['id']; ?>?rp=<?php echo $redirectPage; ?>">
					<i class="icon icon-trash"></i>
				</a>
			</td>

			<td style="text-align: center;"><?php echo $v['Hang']['id']; ?></td>
		</tr>
		<?php endforeach; ?>
		<?php endif; ?>
	</table>
...
<script type="text/javascript">
    $('#hangxe_type').change(function() {
        var v = $(this).val();
        document.location.href = "<?php echo DOMAINAD; ?>admin_hang/hang_list/?t="+v;
    });
