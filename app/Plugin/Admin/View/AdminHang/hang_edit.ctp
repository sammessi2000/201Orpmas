...
<form action="" method="post" class="form-horizontal form-main">
    <div id="main">
        <div class="container-fluid">
            <?php echo $this->Admin->admin_head('Sửa Đối tác'); ?>
            ...
            <div class="box">
                <div class="box-content">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <?php echo $this->Form->hidden('Hang.title'); ?>
                            <?php echo $this->Form->input('Hang.' . $title, array('type'=>'text','label'=>false,'div'=>false, 'class'=>'span6')); ?>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <?php echo $this->Form->input('Hang.image', array('label' => false, 'div' => false, 'class' => 'span6 image_preview', 'id' => 'thumbnail', 'required')); ?>
                            <input type="button" class="btn btn-info" onclick="file_manager('thumbnail');"
                                value="Chọn ảnh">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            $initialValue = $this->data['Hang'][$description];

                            echo $CKEditor->editor("data[Hang][" . $description . "]", $initialValue, "extra");
                            ?>
                        </div>
                    </div>
        ...
        <?php /*
            ...
            <div class="controls">
                <?php echo $this->Form->input('Hang.website', array('label' => false, 'div' => false, 'class' => 'span6')); ?>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                $initialValue = $this->data['Hang'][$content];

                echo $CKEditor->editor("data[Hang][" . $content . "]", $initialValue, "extra");
                ?>
                </div>
            </div>
