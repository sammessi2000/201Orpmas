...
<?php echo $this->Admin->admin_head('Sửa ' . $form_title); ?>
...
*/ ?>
            <div class="control-group">
                ...
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.fullname', array('label' => false, 'div' => false, 'class' => 'span6')); ?>
                </div>
            </div>
           ...
           <!--  <div class="control-group">
                <div class="span1 text-bold">Công ty</div>
                <div class="span9">
          ...
          <!--   <div class="control-group">
                <div class="span1 text-bold">Điện thoại </div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.phone', array('label' => false, 'div' => false, 'class' => 'span6')); ?>
                </div>
            </div> -->

    <!--          <div class="control-group">
                <div class="span1 text-bold">Chức vụ </div>
                <div class="span9">
            ...
            <?php /*
        <div class="control-group">
            <div class="span1 text-bold">Slug </div>
            <div class="span9">
                <?php echo $this->Form->input('Node.slug', array('type'=>'text', 'div'=>false, 'label'=>false, 'class'=>'custome_slug span9')); ?>
        ...
        */ ?>
            ...
            <div class="control-group">
                ...
                <div class="span9">
                    <?php echo $this->Form->input('category_id', array('label' => false, 'div' => false, 'required', 'class' => 'span6', 'options' => $category_tree, 'selected' => $cat_selected, 'multiple' => true, 'style'=>'height: 200px;')); ?>
                </div>
            </div>
*/ ?>
            <div class="control-group">
