<div class="navbar margin-none">
    <div class="navbar-inner radius-none">
        <a class="brand" href="#">Thêm mới đối tác</a>
    </div>
</div>
...
<?php echo $this->Form->create(null, array('url'=>array('plugin'=>'admin', 'controller'=>'admin_partner','action'=>'partner_add'), 'type'=>'post', 'class'=>'form-horizontal')); ?>
