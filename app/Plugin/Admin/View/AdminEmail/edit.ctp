    ...
    <form action="" method="post" class="form-horizontal">
        <div class="row-fluid news_content_workspace">
            ...
            <div class="control-group">
                ...
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.email_category', array('label' => false, 'div' => false, 'required', 'class' => 'span6', 'options' => $category_tree, 'selected' => $this->data[$tbl]['email_category'], 'empty' => 'Chọn mục lục')); ?>
                </div>
            </div>
            ...
            <div class="control-group">
                <div class="span1 text-bold">Email forwarder </div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.forwarder', array('label' => false, 'div' => false, 'class' => 'span6')); ?>
                </div>
            </div>

            <div class="control-group">
                <div class="span1 text-bold">Mail list </div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.mail_list', array('label' => false, 'div' => false, 'class' => 'span6')); ?>
                </div>
            </div>

            <div class="control-group">
                <div class="span1 text-bold">Park domain </div>
                <div class="span9">
                    <?php echo $this->Form->input($tbl . '.park', array('label' => false, 'div' => false, 'class' => 'span6')); ?>
                </div>
            </div>
