...
<div class="navbar margin-none">
    <div class="navbar-inner radius-none">
        ...
        <ul class="nav pull-right">
            <li>
                <a href="<?php echo Router::url(array('plugin' => 'admin', 'controller' => 'admin_tuvan', 'action' => 'tuvan_add')); ?>">
...
<div class="well radius-none bg-white">
    ...
    <table class="table table-hover table-bordered">
        ...
        <tr>
            <td>
                <?php if($v['Tuvan']['image'] == '') : ?>
                    ----
                <?php elseif(!preg_match('/http/', $v['Tuvan']['image'])) : ?>
                    <img src="<?php echo DOMAIN; ?>timthumb.php?src=<?php echo DOMAIN . $v['Tuvan']['image']; ?>&w=70&zc=1" />
                <?php else : ?>
                    <img src="<?php echo $v['Tuvan']['image']; ?>" width="70" />
                <?php endif; ?>
            </td>
            <td>
            ...
            <td>
                <?php echo $this->requestAction('admin/admin_tuvan/get_list_category_name/' . $v['Node']['id']); ?>
            </td>
            <td>
            ...
            <td>
                <a href="<?php echo DOMAINAD; ?>admin_tuvan/update_field/featured/<?php echo $v['Tuvan']['id']; ?>">
                    <?php if($v['Tuvan']['featured'] == 1) : ?>
            ...
            <td>                
                <a href="<?php echo Router::url(array('plugin'=>'admin', 'controller'=>'admin_tuvan', 'action'=>'tuvan_edit', $v['Node']['id']), true); ?>"><i class="icon icon-edit"></i></a> &nbsp;
            ...
            <td>
                <a href="<?php echo DOMAINAD; ?>admin_tuvan/tuvan_copy/<?php echo $v['Node']['id']; ?>">
...
$('#btn-filter').click(function() {
    ...
    document.location.href = "<?php echo Router::url(array('plugin'=>'admin','controller'=>'admin_tuvan','action'=>'tuvan_list'), TRUE); ?>/?list_category="+category + "&filter_status=" + status;
});  
</script>