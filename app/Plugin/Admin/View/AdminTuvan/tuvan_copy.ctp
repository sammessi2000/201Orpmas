...
<div class="well bg-white radius-none">
    ...
    <form action="<?php echo DOMAINAD; ?>admin_tuvan/tuvan_add" method="post" class="form-horizontal">
        <div class="row-fluid news_content_workspace">
            ...
            <div class="control-group">
                ...
                <div class="span9 news_content_ckeditor">
                    ...
                    $initialValue = $this->data['Tuvan'][$content];
            ...
            <div class="control-group">
                ...
                <div class="span9">
                    ...
                    echo $this->Form->input('Tuvan.tags', array('type' => 'textarea', 'div' => false, 'label' => false, 'class' => 'span11', 'rows' => 3, 'cols' => false, 'value'=>$str_tag));
                    ?>
                </div>
            </div> 
