...
class AdminFaqController extends AdminAppController {
    ...
    public $uses = array('Faq', 'Admin.Category', 'Node', 'CategoryLinked');
    public $type = 'faq';
    public $tbl = 'Faq';
    public $form_title = 'Faq';
    ...
    public function faq_add() {
        if($this->data)
        {
            ...
            $data['image2'] = $this->remove_hostname($data['image2']);
    ...
    public function faq_delete($node_id)
    {
    ...
    public function faq_copy($node_id)
    {
        $this->faq_edit($node_id);
    }
}
