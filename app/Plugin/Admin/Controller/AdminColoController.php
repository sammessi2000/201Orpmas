...
class AdminColoController extends AdminAppController {

    public $uses = array('Colo', 'Admin.Category', 'Node', 'CategoryLinked');

    public $type = 'colo';
    public $tbl = 'Colo';
    public $table = 'colos';
    public $form_title = 'Dịch vụ Colocation';
    ...
    public function beforeFilter()
    {
        ...
        $this->get_categories(array('type'=>array('colo', 'server')));
    }
    ...
    public function setting()
    {
        ...
        $fields = array(
            ...
            'bwtrongnc' => 'WB Trong nước', 
            'bwqte' => 'WB Quốc tế', 
            'csnguon' => 'Công suất nguồn', 
            'ip' => 'IP', 
            'uptime' => 'Uptime', 
