...
class AdminCloudController extends AdminAppController {

    public $uses = array('Cloud', 'Admin.Category', 'Node', 'CategoryLinked');

    public $type = 'cloud';
    public $tbl = 'Cloud';
    public $table = 'clouds';
    public $form_title = 'VPS Cloud';
    ...
    public function beforeFilter()
    {
        ...
        $this->get_categories(array('type'=>'cloud'));
    }
