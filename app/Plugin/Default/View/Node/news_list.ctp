            ...
            <div class="col-sm-8 col-xs-12">
                ...
                <?php if(isset($this->data) && is_array($this->data) && count($this->data) > 0) { ?>
                    <?php $i=0; foreach($this->data as $v) { $i++; ?>
                        <div class="archive-item row <?php if($i==1) echo 'first-featured'; ?>">
                        <div class="col-sm-12">
                        <div class="body">
                        <div class="row">
                    <?php if($i == 1) { ?>
                            <div class="col-sm-6 img">
                                <a href="<?php echo DOMAIN . $v['Node']['slug']; ?>.html" class="">
                                    <img width="351" height="263" class="lazy" src="<?php echo DOMAIN; ?>theme/default/img/blank.svg" data-src="<?php echo DOMAIN . $v['News']['image']; ?>" alt="<?php echo $v['Node']['title']; ?>" />
                                </a>
                            </div>
                ...
                <div class="col-sm-4 col-xs-12"><?php echo View::element('sidebar'); ?></div>
        </div>
    </div>
</div>
