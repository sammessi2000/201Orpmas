    ...
    <div class="wrap">
        <div class="row">
            ...
            <div class="col-sm-9 product-list">
                ...
                <div class="news-list-archive thanhtuu-list">
                <?php $i=0; $j=0; $n=count($data); foreach($data as $v) { $i++; $j++; ?>
                    <div class="thanhtuu-item <?php if($j==$n) echo 'last'; ?>">
                    <div class="row <?php if($j==1) echo 'first'; ?>">
	                    <div class="col-sm-6 <?php if($i==2) echo 'pull-right'; ?>">
		                    <div class="news-list-img col-sm-6 <?php if($i==2) echo 'pull-right'; ?>">
                                <h2>
		                            <?php echo $this->App->img($v['News']['image'], $v['Node']['title'], 220, 280); ?>
                                </h2>
		                    </div>
