                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="name-dtpro">
                            <?php echo $this->App->t('title', $data['Hangxe']); ?>
                            <?php echo $this->App->adm_link('hang', $data['Hangxe']['id']); ?>
                        </div>
                        <p class="tags-dtpro"></p>
                        <div class="content-dtpro">
                            <?php echo $this->App->t('content', $data['Hangxe']); ?>
                        </div>
                                    ...
                                    <figure>
                                        <div class="hovereffect">
                                            <a href="<?php echo DOMAIN . $v['Node']['slug']; ?>.html" title="">
                                                <img src="<?php echo DOMAIN . $v['Product']['image']; ?>" alt="">
                                            </a>
...
<div class="product-detail">
  <div class="leftBox" id="proView">
    <div class="viewLeft">
      <div id="pro_img_main">
          ...
          <div id="bridal_images"> 
            <div id="wrap">
            <?php $imgs = DOMAIN . $data['News']['image']; ?>
    ...
    <!--end viewLeft-->
    <div class="viewRight">
      <div class="titleView"><?php echo $this->App->t('title', $data['Node']); ?><?php echo $this->App->adm_link('product', $data['Node']['id']); ?></div>
      <h1>Giá bán: <?php echo $data['News']['price'] > 0 ? number_format($data['News']['price']) : 'Liên hệ'; ?>  ₫ </h1>
      <div class="desc">
        <?php echo $this->App->t('description', $data['News']); ?>
      </div>
      <div class="clr"></div>
      <div id="sharelink"> 
      ...
      <form action="#" method="post" name="orderform" id="orderform">
          <div class="quantity">
            ...
            <a href="javascript:" onclick="add_to_cart2(<?php echo $data['Node']['id']; ?>)" style="cursor:pointer">Mua hàng</a> 
            <div class="clr"></div>
            </div>
        </form>
      <div class="clr"></div>
  ...
  <div id="pro_tabs">
    ...
    <div id="tab1" class="tabs" style="display: block;">
      <div id="tabs_content" class="showText">
          <?php echo $this->App->t('content', $data['News']); ?>
      </div>
    </div>
  </div>
  <div class="clr"></div>
  <div class="box_id">
    ...
    <div class="placeSlide_main">
      <div class="placeSlide_with">
        ...
        <?php if(is_array($data['related']) && count($data['related']) > 0) { ?>
        <?php foreach($data['related'] as $v) { ?>
