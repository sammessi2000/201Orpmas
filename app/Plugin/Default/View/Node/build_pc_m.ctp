...
<div id="body_content">
    ...
    <link rel="stylesheet" href="<?php echo DOMAIN; ?>theme/default/style_build_pc_v2.css">
    <link rel="stylesheet" href="<?php echo DOMAIN; ?>theme/default/build_mobile_2020.css">

    <main class="build-pc pc">
        <div class="container">
            <div class="clear"></div>
            <div class="build-pc_content" style="margin-top:0;">
                <h3 style="color:#333;border:none;float:left;margin: 5px 0 15px 0px; line-height: 25px;">
                    <?php echo $this->App->t_a('buildpc-title'); ?>
                </h3>

                <ul class="list-btn-action" style="margin:0 0 15px 0; padding:0; float:right; border:none;">
                    <li style="width:auto;">
                ...
                <div class="wrap-list-drive-mobile">
                ...
                <p style="float:right; font-size:18px; color:#d00; margin-top:15px; margin-bottom:15px;">
                <?php echo $this->App->t('buildpc-chiphidutinh'); ?> 
                    <span class="js-config-summary">
                        <span class="total-price-config">0</span> đ
                    </span>
                ...
                <div class="popup-select">
                    ...
                    <div class="popup-main">
                        <div class="popup-main_content w-70 float_r">
                            ...
                            <div class="list-product-select"></div>
                        </div>
                    </div>
                </div>
            </div> 
